...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        p1.setBackground(new Color(200, 162, 200)); //200, 162, 200
        ...
        JLabel status = new JLabel("Bonetti, Hadassa, Dassu");
        ...
        send.setBackground(new Color(200, 162, 200)); //200, 162, 200
    ...
    public void run() {
        try {
            String msg = "";
            while(true) {
                msg =  client.receber();// reader.readLine();
